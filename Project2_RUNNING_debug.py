...
Ra = 0.1 #accelerometer observation model noise
Rg = .3#.04 # Gyro observation model noise
...
Qa = .1#.5#100#.001#1   # Process model accel noise
Qg = 0.3   # Process model gyro noise
...
ax1.plot(plot_time,UKF_out[5,:],label = 'UKF')
...
ax2.plot(plot_time,UKF_out[4,:],label = 'UKF')
...
ax3.plot(plot_time,UKF_out[3,:],label = 'UKF')
plt.xlabel('time, s')
plt.ylabel('angle, Radians')
plt.legend(loc = 'lower right')
